...
<div class="w clearfix">
	<div id="JS_mll_header_menu_panel" class="menu-panel forbid">
		...
		<ul id="JS_mll_menu_map" class="top" style="padding-bottom:0;">
			...
			<em class="flag flag1" style="margin-top: 11px;"></em>
				<a title="${FirstColumn.name}" class="txt" target="_blank" style="height:40px;line-height:40px;font-size:13px;" href="<s:url value='/patent/getSalePatentByKind.html'/>?firstColumn=${FirstColumn.id}">${FirstColumn.name}</a>				
				<div class="sub" style="width:450px">
					<div class="title clearfix">
						<h4 class="Left"><a href="<s:url value='/patent/getSalePatentByKind.html'/>?firstColumn=${FirstColumn.id}" class="red">${FirstColumn.name}<span class="darrow">&gt;&gt;</span></a></h4>
					</div>
	...
	<ul class="navigator">
      ...
      <li><a target="_blank" href="http://r.lotut.com" title="商标">商标市场</a></li>
      ...
      <li><a target="_blank" href="http://www.lotut.com" title="专利管家">龙图腾门户</a></li>
